            ...
            <div class="container">
                ...
                <div class="breadcrumb">
                    <ul>
                        ...
                        <li><a href="#">Tambah Rekening</a> </li>
                    </ul>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <!-- DataTable -->
                        ...
                        <h1>Tambah Rekening</h1>
                                ...
                                <form action = "proses/prosesTambahRekening.php" method = "POST">
                                    <div class="row">
                                        <div class="col-lg-12 form-group">
                                            <label >Nama Rekening</label>
                                            <input type="text" name="nama"  placeholder="Nama Rekening" class="form-control" >
                                        </div>
                                        <div class="col-lg-12 form-group">
                                            <label >Nomor Rekening</label>
                                            <input type="text" name="nomor"  placeholder="Nomor Rekening" class="form-control" >
                                        </div>
                                        <div class="col-lg-12 form-group">
                                            <label >Bank Rekening</label>
                                            <input type="text" name="bank"  placeholder="Bank Rekening" class="form-control" >
                                        </div>
