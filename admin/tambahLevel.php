...
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800">Tambah Data Akses Level</h1>
...
<div class="card shadow mb-4">
  ...
  <div class="card-body">
    ...
    <form id="form_send" action='proses/prosesTambahLevel.php' method ='post'  enctype="multipart/form-data">	
